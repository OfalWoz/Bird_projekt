...
class Tor_two_two(object):
    ...
    def tick(self):
        ...
        # kolizje
        if self.grass_1.collidepoint((self.p_pos.x, self.p_pos.y)) or self.grass_2.collidepoint(
                (self.p_pos.x, self.p_pos.y)) or self.grass_3.collidepoint(
                (self.p_pos.x, self.p_pos.y)) or self.grass_4.collidepoint(
                (self.p_pos.x, self.p_pos.y)) or self.grass_5.collidepoint(
                (self.p_pos.x, self.p_pos.y)) or self.grass_6.collidepoint(
                (self.p_pos.x, self.p_pos.y)) or self.grass_7.collidepoint(
                (self.p_pos.x, self.p_pos.y)) or self.grass_8.collidepoint(
                (self.p_pos.x, self.p_pos.y)) or self.grass_9.collidepoint(
                (self.p_pos.x, self.p_pos.y)) or self.grass_10.collidepoint(
                (self.p_pos.x, self.p_pos.y)) or self.grass_11.collidepoint(
                (self.p_pos.x, self.p_pos.y)) or self.grass_12.collidepoint(
                (self.p_pos.x, self.p_pos.y)) or self.grass_13.collidepoint((self.p_pos.x, self.p_pos.y)):
            self.p_a *= 0.1

        if self.grass_1.collidepoint((self.p2_pos.x, self.p2_pos.y)) or self.grass_2.collidepoint(
                (self.p2_pos.x, self.p2_pos.y)) or self.grass_3.collidepoint(
                (self.p2_pos.x, self.p2_pos.y)) or self.grass_4.collidepoint(
                (self.p2_pos.x, self.p2_pos.y)) or self.grass_5.collidepoint(
                (self.p2_pos.x, self.p2_pos.y)) or self.grass_6.collidepoint(
                (self.p2_pos.x, self.p2_pos.y)) or self.grass_7.collidepoint(
                (self.p2_pos.x, self.p2_pos.y)) or self.grass_8.collidepoint(
                (self.p2_pos.x, self.p2_pos.y)) or self.grass_9.collidepoint(
                (self.p2_pos.x, self.p2_pos.y)) or self.grass_10.collidepoint(
                (self.p2_pos.x, self.p2_pos.y)) or self.grass_11.collidepoint(
                (self.p2_pos.x, self.p2_pos.y)) or self.grass_12.collidepoint(
                (self.p2_pos.x, self.p2_pos.y)) or self.grass_13.collidepoint((self.p2_pos.x, self.p2_pos.y)):
            self.p2_a *= 0.1
        ...
        if self.check_3.collidepoint((self.p2_pos.x, self.p2_pos.y)) and self.check2 == 2:
            self.check2 += 1
            print(self.check)
            pygame.mixer.music.load('UI_Quirky1.mp3')
            pygame.mixer.music.play()

        if self.check_4.collidepoint((self.p2_pos.x, self.p2_pos.y)) and self.check2 == 3:
            self.check2 += 1
            print(self.check)
            pygame.mixer.music.load('UI_Quirky1.mp3')
            pygame.mixer.music.play()

        if self.check_5.collidepoint((self.p2_pos.x, self.p2_pos.y)) and self.check2 == 4:
            self.check2 += 1
            print(self.check)
            pygame.mixer.music.load('UI_Quirky1.mp3')
            pygame.mixer.music.play()
        ...
        if self.check2 >= 5 and self.stop.collidepoint((self.p2_pos.x, self.p2_pos.y)):
            pygame.mixer.music.load('UI_Quirky1.mp3')
            pygame.mixer.music.play()
            self.check2 = 0
            self.lap2 += 1
    ...
    def draw(self):
        ...
        draw_text('Punkty kontrolne RED: '+str(self.check)+'/5', self.font, (255, 255, 255), self.game.screen, 10, 80)
        draw_text('Punkty kontrolne BLUE: ' + str(self.check2) + '/5', self.font, (255, 255, 255), self.game.screen, self.game.szerokosc/2 + 345, 80)
